...
const Task = () => {
  ...
  const initialTaskState: ITaskData = {
    id: undefined,
    name: "",
  ...
  const [mathsDiscipline, setMathsDiscipline] = useState<boolean>(
    testDefineConst(currentTask.discipline, 0)
  );
  const [physicsDiscipline, setPhysicDiscipline] = useState<boolean>(
    testDefineConst(currentTask.discipline, 1)
  );
        ...
        <div className="container-edit-form-1">
          ...
          <form className="form-edit-1">
            ...
            <div className="form-group-2">
              <label htmlFor="discipline" className="form-label-2">
                Discipline :{" "}
              </label>
            </div>
